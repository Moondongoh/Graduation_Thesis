...
def load_data_from_csv(data_path, csv_path):
    ...
    if not features:
        print(
            "오류: 로드할 수 있는 .npy 파일이 없습니다. 경로와 파일 이름을 확인해주세요."
        )
        return None, None, None, None
...
if __name__ == "__main__":
    ...
    NPY_DATA_PATH = r"D:\MDO\heartbeat\1_New_HB_0818\2D_CNN\change_csv\processed_data"
    CSV_PATH = r"D:\MDO\heartbeat\1_New_HB_0818\2D_CNN\change_csv\processed_data\REFERENCE2.csv"
    MODEL_SAVE_PATH = (
        r"D:\MDO\heartbeat\1_New_HB_0818\2D_CNN\model\binary_audio_cnn_model.pth"
    )

    train_dataset, test_dataset, class_names, max_len = load_data_from_csv(
        NPY_DATA_PATH, CSV_PATH
    )
...
#             # 네 번째 층
#             nn.Conv2d(128, 256, kernel_size=(3, 3)), nn.ReLU(), nn.MaxPool2d((2, 2)), nn.Dropout(0.25)
#         )
#         self.flatten = nn.Flatten()
#         self.fc_layers = None
...
#     # --- 경로 설정 ---
#     NPY_DATA_PATH = r'D:\MDO\heartbeat\1_New_HB_0818\2D_CNN\change_csv\processed_data'
#     CSV_PATH = r'D:\MDO\heartbeat\1_New_HB_0818\2D_CNN\change_csv\processed_data\REFERENCE2.csv' # 실제 CSV 파일 경로
#     MODEL_SAVE_PATH = r'D:\MDO\heartbeat\1_New_HB_0818\2D_CNN\model\4binary_audio_cnn_model.pth' # 새로 저장될 모델 이름
#     # -----------------
