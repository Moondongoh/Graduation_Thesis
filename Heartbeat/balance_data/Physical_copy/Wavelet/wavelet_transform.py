...
if __name__ == "__main__":
    ...
    p.add_argument(
        "--src-dir",
        default=r"D:\MDO\heartbeat\1_New_HB_0818\balance_data\Physical_copy\Dataset",
        help="입력 WAV 폴더",
    )
    p.add_argument(
        "--out-csv",
        default=r"D:\MDO\heartbeat\1_New_HB_0818\balance_data\Physical_copy\Wavelet\wavelet_features.csv",
        help="출력 CSV 경로",
    )
    p.add_argument(
        "--reference-csv",
        default=r"D:\MDO\heartbeat\1_New_HB_0818\balance_data\Physical_copy\Dataset\REFERENCE2_balanced.csv",
