...
if __name__ == "__main__":
    ...
    # ==========================================================경로 지정==========================================================
    input_wav_folder_path = r"D:\MDO\heartbeat\classification-of-heart-sound-recordings-the-physionet-computing-in-cardiology-challenge-2016-1.0.0/validation"

    # 2. 변환된 1D TXT 파일을 저장할 폴더 경로
    # folder_structure.txt에 따르면 [Read_1D_Data]/[result] 안에 있는 것으로 보입니다.
    # ==========================================================경로 지정==========================================================
    output_1d_txt_directory = "Wavelet/Validation_Transformed_Data"

    # 3. 모든 파일명 접두사와 라벨 정보를 담고 있는 REFERENCE.csv 파일 경로
    # 일반적으로 입력 WAV 폴더와 같은 상위 디렉토리에 있습니다.
    # ==========================================================경로 지정==========================================================
    label_csv_file = r"D:\MDO\heartbeat\classification-of-heart-sound-recordings-the-physionet-computing-in-cardiology-challenge-2016-1.0.0/validation/REFERENCE.csv"
